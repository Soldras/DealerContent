...
use DealerContent\Model\DealerContentVersion as ChildDealerContentVersion;
use DealerContent\Model\DealerContentVersionQuery as ChildDealerContentVersionQuery;
use DealerContent\Model\Map\DealerContentTableMap;
use DealerContent\Model\Map\DealerContentVersionTableMap;
...
abstract class DealerContent implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\DealerContent\\Model\\Map\\DealerContentTableMap';
    ...
    /**
     * Initializes internal state of DealerContent\Model\Base\DealerContent object.
     * @see applyDefaults()
     */
     ...
     * @return   \DealerContent\Model\DealerContent The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \DealerContent\Model\DealerContent object", 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->dealerContentVersionsScheduledForDeletion !== null) {
                if (!$this->dealerContentVersionsScheduledForDeletion->isEmpty()) {
                    \DealerContent\Model\DealerContentVersionQuery::create()
     ...
     * objects.
     *
     * @param      object $copyObj An object of \DealerContent\Model\DealerContent (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \DealerContent\Model\DealerContent Clone of current object.
     * @throws PropelException
     */
    ...
    public function initDealerContentVersions($overrideExisting = true)
    {
        ...
        $this->collDealerContentVersions->setModel('\DealerContent\Model\DealerContentVersion');
    }
     ...
     *
     * @return \DealerContent\Model\DealerContent
     */
     ...
     * @return PropelCollection|array \DealerContent\Model\DealerContentVersion[] List of \DealerContent\Model\DealerContentVersion objects
     */
